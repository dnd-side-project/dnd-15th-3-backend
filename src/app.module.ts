...
import { MockApiModule } from './mock/mock-api.module'
...
const mockApiEnabled = ['true', '1'].includes(
  process.env.MOCK_API_ENABLED?.trim().toLowerCase() ?? '',
)

const infrastructureModules = mockApiEnabled
  ? []
  : [
